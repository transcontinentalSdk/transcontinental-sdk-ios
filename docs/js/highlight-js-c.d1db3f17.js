    ...
    "1fe5": function (e, n) {
      function s(e) {
        const n = e.regex,
          ...
          b = [u, l, s, e.C_BLOCK_COMMENT_MODE, d, c],
          w = {
            variants: [
              { begin: /=/, end: /;/ },
              { begin: /\(/, end: /\)/ },
          ...
          h = {
            ...
            illegal: /[^\w\s\*&:<>.]/,
            contains: [
              { begin: t, keywords: f, relevance: 0 },
              {
                begin: p,
                returnBegin: !0,
              ...
              { relevance: 0, match: /,/ },
              {
                ...
                contains: [
                  ...
                  l,
                  {
                    ...
                    keywords: f,
                    relevance: 0,
                    contains: ["self", s, e.C_BLOCK_COMMENT_MODE, c, d, l],
                  },
                ],
              },
              l,
        ...
        return {
          ...
          exports: { preprocessor: u, strings: c, keywords: f },
        };
      }
      e.exports = s;
    },
