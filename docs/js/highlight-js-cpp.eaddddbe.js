      ...
      function n(e) {
        const t = e.regex,
          ...
          s =
            ...
            t.optional(r) +
            ")",
          c = { className: "type", begin: "\\b[a-z\\d_]*_t\\b" },
          ...
          h = ["NULL", "false", "nullopt", "nullptr", "true"],
          w = ["_Pragma"],
          y = { type: g, keyword: m, literal: h, built_in: w, _type_hints: f },
          v = {
          ...
          k = [v, u, c, n, e.C_BLOCK_COMMENT_MODE, d, l],
          x = {
            variants: [
              { begin: /=/, end: /;/ },
              { begin: /\(/, end: /\)/ },
              ...
              { relevance: 0, match: /,/ },
              {
                ...
                contains: [
                  ...
                  c,
                  {
                    ...
                    keywords: y,
                    relevance: 0,
                    contains: ["self", n, e.C_BLOCK_COMMENT_MODE, l, d, c],
                  },
                ],
              },
              c,
