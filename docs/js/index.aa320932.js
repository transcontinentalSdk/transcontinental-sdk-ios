 ...
 */ (function (e) {
  function t(t) {
    for (
      var n, i, c = t[0], a = t[1], h = t[2], l = 0, u = [];
      l < c.length;
      l++
    )
      (i = c[l]),
  ...
  "002d": function (e, t, o) {
    ...
    const a = {
      ...
      h = { cardinal: "cardinal", ordinal: "ordinal" };
    function l(e, t) {
      const { cardinal: o } = h,
        { one: n, other: i } = a,
        r = "en",
      ...
      if (!e[r] || !e[r][s])
        throw new Error(
          "No default choices provided to pluralize using default locale " + r,
        );
      let c = r,
        l = s;
      if ("Intl" in window && "PluralRules" in window.Intl) {
        const n = navigator.languages
            ? navigator.languages
            : [navigator.language],
          i = new Intl.PluralRules(n, { type: o }),
          r = i.select(t),
    ...
    function g(e) {
      ...
      for (t = 0; t < s; t += 1)
        (o = r[t]),
          "\\" === o
            ? (c.push(`${0 === t ? "" : n}${o}`), c.push(r[t + 1]), (t += 1))
            : 0 === t
            ? c.push(o)
            : o !== i && c.push(`${n}${o}`);
      return c.join("");
  ...
  "63b8": function (e, t, o) {
    ...
    const n = { large: "large", medium: "medium", small: "small" },
      i = { default: "default", nav: "nav" },
      r = {
        [i.default]: {
          [n.large]: { minWidth: 1069, contentWidth: 980 },
          [n.medium]: { minWidth: 736, maxWidth: 1068, contentWidth: 692 },
          [n.small]: { minWidth: 320, maxWidth: 735, contentWidth: 280 },
        },
        [i.nav]: {
          [n.large]: { minWidth: 1024 },
          [n.medium]: { minWidth: 768, maxWidth: 1023 },
          [n.small]: { minWidth: 320, maxWidth: 767 },
        },
      },
      s = { [n.small]: 0, [n.medium]: 1, [n.large]: 2 };
    function c(e, t) {
      return s[e] > s[t];
    }
  },
  ...
  "748c": function (e, t, o) {
    ...
    function r(e) {
      ...
      return t.reduce((t, o) => {
        ...
        return n ? t.concat({ density: o, src: n.url, size: n.size }) : t;
      }, []);
    }
    function s(e) {
      const t = "/",
  ...
  d26a: function (e, t, o) {
    ...
    var n = o("748c"),
      i = { input: "input", tags: "tags" };
    function r(e = {}) {
      return Object.entries(e)
        .reduce(
          (e, [t, o]) =>
            o
              ? e.concat(`${encodeURIComponent(t)}=${encodeURIComponent(o)}`)
              : e,
          [],
        )
        .join("&");
    }
    function s(e, { changes: t, language: o, context: n } = {}) {
      const [i, s] = e.split("#"),
        c = i.match(/\?.*/),
        a = r({ changes: t, language: o, context: n }),
        h = c ? "&" : "?",
        l = s ? i : e,
        u = a ? `${h}${a}` : "",
        d = s ? "#" + s : "";
    ...
    function c(e, t) {
      const {
          query: { changes: o, [i.input]: n, [i.tags]: r, ...s } = {},
        } = e,
        {
          query: { changes: c, [i.input]: a, [i.tags]: h, ...l } = {},
        } = t;
      return (
        e.name === t.name &&
        JSON.stringify({ path: e.path, query: s }) ===
          JSON.stringify({ path: t.path, query: l })
      );
    }
  ...
  d369: function (e, t, o) {
    ...
    const i = {
      ...
      r = { preferredColorScheme: "docs.setting.preferredColorScheme" };
    t["a"] = Object.defineProperties(
      {},
  ...
  e425: function (e, t, o) {
    ...
    const s =
        ...
        [n["a"].light.value, n["a"].dark.value, "no-preference"].some(
    ...
    t["a"] = {
      ...
      syncPreferredColorScheme() {
        r["a"].preferredColorScheme &&
          r["a"].preferredColorScheme !== this.state.preferredColorScheme &&
          (this.state.preferredColorScheme = r["a"].preferredColorScheme);
      },
    };
  },
  e487: function (e, t, o) {},
  ...
  f161: function (e, t, o) {
    ...
    var n = o("2b0e"),
      ...
      r = function () {
        ...
        return o(
          ...
          [
            o("div", { attrs: { id: e.AppTopID } }),
            o("a", { attrs: { href: "#main", id: "skip-nav" } }, [
              e._v("Skip Navigation"),
            ]),
            o("InitialLoadingPlaceholder"),
            e._t(
              "header",
              function () {
                return [
                  e.hasCustomHeader
                    ? o("custom-header", {
                        attrs: { "data-color-scheme": e.preferredColorScheme },
                      })
                    : e._e(),
                ];
              },
            ...
            o("div", { attrs: { id: e.baseNavStickyAnchorId } }),
            e._t(
              "default",
              function () {
                return [
                  o("router-view", { staticClass: "router-content" }),
                  e.hasCustomFooter
                    ? o("custom-footer", {
                        attrs: { "data-color-scheme": e.preferredColorScheme },
                      })
      ...
      h = function () {
        ...
        return o("footer", { staticClass: "footer" }, [
          o("div", { staticClass: "row" }, [o("ColorSchemeToggle")], 1),
        ]);
      },
      l = [],
      u = function () {
        ...
        return o(
          ...
          e._l(e.options, function (t) {
            return o("label", { key: t.value }, [
              ...
              o("div", { staticClass: "text" }, [e._v(e._s(t.label))]),
            ]);
          }),
          0,
        );
      ...
      j = p.exports,
      v = { name: "Footer", components: { ColorSchemeToggle: j } },
      w = v,
    ...
    var x = o("4009"),
      D = {
        name: "CoreApp",
        components: { Footer: y, InitialLoadingPlaceholder: T },
        provide() {
          return {
        ...
        async created() {
          window.addEventListener("keydown", this.onKeyDown),
            ...
            this.enableThemeSettings &&
              Object.assign(this.themeSettings, await Object(O["b"])()),
        ...
        mounted() {
          ((document.querySelector(".footer-current-year") || {}).innerText =
      ...
      N =
        (o("5c0b"),
        o("a5c6"),
        Object(m["a"])($, r, s, !1, null, "0a4c340a", null)),
      R = N.exports;
    class U {
      constructor() {
        this.$send = () => {};
    ...
    function H(e, t = { names: ["header", "footer"] }) {
      const { names: o } = t;
    ...
    var G = { hide: K };
    function z(e, { performanceMetrics: t = !1 } = {}) {
      (e.config.productionTip = !1),
        e.use(H),
        e.directive("hide", G.hide),
        e.use(W, {
          appTarget: Object({
            NODE_ENV: "production",
            VUE_APP_TITLE: "Documentation",
        ...
        const { name: t, query: o, hash: n } = e,
          ...
          h =
            ...
            Object({
              ...
              ? 0
              : a;
        return { selector: Object(Q["b"])(n), offset: { x: 0, y: h } };
      }
      return !Object(Z["a"])(e, t) && { x: 0, y: 0 };
    }
    async function re() {
      ...
      if (e) {
        ...
        oe() === e.location &&
          (await Object(X["b"])(2), window.scrollTo(e.x, e.y));
      }
    }
    function se() {
    ...
    var ce = function () {
      ...
      he = function () {
        var e = this,
          t = e.$createElement,
          o = e._self._c || t;
        return o("div", { staticClass: "generic-error" }, [
          o(
            "div",
            { staticClass: "container" },
            [
              o("h1", { staticClass: "title error-content" }, [
                e._v(e._s(e.message)),
              ]),
              e._t("default"),
            ],
      ...
      ue = {
        name: "GenericError",
        props: {
          message: { type: String, default: "An unknown error occurred." },
        },
      },
      de = ue,
      ge = (o("7138"), Object(m["a"])(de, he, le, !1, null, "790053de", null)),
      fe = ge.exports,
      me = { name: "ServerError", components: { GenericError: fe } },
      pe = me,
      ...
      we = function () {
        ...
        return o(
          "GenericError",
          { attrs: { message: "The page you’re looking for can’t be found." } },
          [e._t("default")],
          2,
        );
      },
      be = [],
      ye = { name: "NotFound", components: { GenericError: fe } },
      Se = ye,
      ...
      _e = [
        {
          ...
          component: () =>
            Promise.all([
              o.e("documentation-topic~topic~tutorials-overview"),
              o.e("tutorials-overview"),
            ]).then(o.bind(null, "f025")),
        },
        {
          path: "/tutorials/:id/*",
          name: "topic",
          component: () =>
            Promise.all([
              o.e("documentation-topic~topic~tutorials-overview"),
              o.e("documentation-topic~topic"),
              o.e("topic"),
            ]).then(o.bind(null, "3213")),
        },
        {
          path: "/documentation/*",
          name: J["a"],
          component: () =>
            Promise.all([
              ...
              o.e("chunk-384ef189"),
              o.e("documentation-topic~topic"),
              o.e("documentation-topic"),
            ]).then(o.bind(null, "f8ac")),
        },
        { path: "*", name: J["b"], component: Ce },
        { path: "*", name: "server-error", component: ve },
      ];
    function Pe(e = {}) {
      const t = new i["a"]({
        mode: "history",
      ...
      return (
        ...
        "ide" !==
          ...
          t.onError((e) => {
            const { route: o = { path: "/" } } = e;
            t.replace({ name: "server-error", params: [o.path] });
          }),
        window.addEventListener("unload", se),
        t
      );
    }
    n["default"].use(z),
      n["default"].use(i["a"]),
      new n["default"]({ router: Pe(), render: (e) => e(R) }).$mount("#app");
  },
  f8ba: function (e, t, o) {},
  fb1e: function (e, t, o) {},
});
